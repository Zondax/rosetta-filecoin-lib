...
func (r RosettaConstructionFilecoin) ConstructMultisigPaymentV5(request *MultisigPaymentRequest, destinationActorId cid.Cid) (string, error) {
...
func (r RosettaConstructionFilecoin) ConstructSwapAuthorizedPartyV5(request *SwapAuthorizedPartyRequest, destinationActorId cid.Cid) (string, error) {
	if destinationActorId != builtin.MultisigActorCodeID {
		return "", fmt.Errorf("this actor id is not supported")
	}
...
func (r RosettaConstructionFilecoin) ConstructRemoveAuthorizedPartyV5(request *RemoveAuthorizedPartyRequest, destinationActorId cid.Cid) (string, error) {
	if destinationActorId != builtin.MultisigActorCodeID {
		return "", fmt.Errorf("this actor id is not supported")
	}
