...
func (r RosettaConstructionFilecoin) ConstructMultisigPaymentV2(request *MultisigPaymentRequest, destinationActorId cid.Cid) (string, error) {
...
func (r RosettaConstructionFilecoin) ConstructSwapAuthorizedPartyV2(request *SwapAuthorizedPartyRequest, destinationActorId cid.Cid) (string, error) {
	if destinationActorId != builtin.MultisigActorCodeID {
		return "", fmt.Errorf("this actor id is not supported")
	}
...
func (r RosettaConstructionFilecoin) ConstructRemoveAuthorizedPartyV2(request *RemoveAuthorizedPartyRequest, destinationActorId cid.Cid) (string, error) {
	if destinationActorId != builtin.MultisigActorCodeID {
		return "", fmt.Errorf("this actor id is not supported")
	}
