...
func (r RosettaConstructionFilecoin) ConstructMultisigPaymentV1(request *MultisigPaymentRequest, destinationActorId cid.Cid) (string, error) {
...
func (r RosettaConstructionFilecoin) ConstructSwapAuthorizedPartyV1(request *SwapAuthorizedPartyRequest, destinationActorId cid.Cid) (string, error) {
	if destinationActorId != builtin.MultisigActorCodeID {
		return "", fmt.Errorf("this actor id is not supported")
	}
...
func (r RosettaConstructionFilecoin) ConstructRemoveAuthorizedPartyV1(request *RemoveAuthorizedPartyRequest, destinationActorId cid.Cid) (string, error) {
	if destinationActorId != builtin.MultisigActorCodeID {
		return "", fmt.Errorf("this actor id is not supported")
	}
